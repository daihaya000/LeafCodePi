...
LeafCodePi bundles this fork as the required `leafcode-intercom` extension and its WebUI loads the bundled source automatically.
...
LeafCodePi loads `extensions/leafcode-intercom` automatically. For standalone Pi, install the upstream package:
