<p>
  <img src="banner.png" alt="leafcode-web-access" width="1100">
</p>

# LeafCode Web Access

LeafCodePi-maintained fork of [`pi-web-access`](https://github.com/nicobailon/pi-web-access), bundled as a built-in extension.
...
[![npm version](https://img.shields.io/npm/v/leafcode-web-access?style=for-the-badge)](https://www.npmjs.com/package/leafcode-web-access)
...
```bash
pi install ./extensions/leafcode-web-access
```
