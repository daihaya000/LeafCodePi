...
// Resolve the path to leafcode-memory's own extension entry point.
...
// leafcode-memory's own package.json declares) and match sibling package
...
// default: packages installed alongside leafcode-memory's own package
// (the common npm-managed-extensions layout), and AGENT_ROOT's npm
// directory (covers leafcode-memory being loaded from elsewhere, e.g. a
