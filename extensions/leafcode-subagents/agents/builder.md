...
aliases: build
tools: read, memory_search, memory_add, memory_replace, memory_remove, session_search, skill_manage, question, grep, find, ls, powershell, bash, edit, write, subagent, todowrite, tool_search, web_search, source_check, fetch_content, get_search_content, contact_supervisor, subagent_wait, structured_output, task_mutation_decision, watchdog_permission_decision, watchdog_warn, intercom, mcp
