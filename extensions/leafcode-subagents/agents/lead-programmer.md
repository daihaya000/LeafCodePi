...
tools: read, memory_search, memory_add, memory_replace, memory_remove, session_search, skill_manage, grep, find, ls, powershell, bash, edit, write, question, subagent, todowrite, web_search, source_check, fetch_content, get_search_content
