---
name: scout
description: 高速なコードベース偵察。引き継ぎ用に圧縮したコンテキストを返す。
tools: read, memory_search, memory_add, memory_replace, memory_remove, session_search, skill_manage, question, grep, find, ls, powershell, bash, write, todowrite
thinking: low
