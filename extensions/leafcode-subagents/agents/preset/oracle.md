...
tools: read, memory_search, memory_add, memory_replace, memory_remove, session_search, skill_manage, grep, find, ls, powershell, bash, question
thinking: high
...
Working rules:
- Use `powershell` for inspection, verification, or read-only analysis.
