...
tools: read, memory_search, memory_add, memory_replace, memory_remove, session_search, skill_manage, question, powershell, bash, write, web_search, source_check, fetch_content, get_search_content
thinking: medium
