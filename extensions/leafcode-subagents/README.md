...
| `planner` | Read-only codebase analysis that produces an implementation plan before changes. |
...
| Create an implementation plan | "Use planner to analyze this change before implementation." |
