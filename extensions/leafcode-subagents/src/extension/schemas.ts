...
const SubagentParamProperties = {
	...
	isolation: Type.Optional(Type.String({ enum: ["none", "worktree"], description: "Workflow child isolation. none runs in the shared cwd; worktree is rejected in LeafCode collaboration strict mode." })),
	worktree: Type.Optional(Type.Boolean({ description: "Managed child isolation. true is rejected in LeafCode collaboration strict mode; shared checkout runs use false or omit this field." })),
