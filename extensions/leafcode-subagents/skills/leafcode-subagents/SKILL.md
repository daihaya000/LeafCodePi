...
Read the matching reference file before acting. Paths are relative to this `SKILL.md`; resolve them against `skills/leafcode-subagents/` and load them with the read tool.
