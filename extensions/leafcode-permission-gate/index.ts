...
const SYSTEM_SAFETY_RULES: readonly SystemSafetyRule[] = [
  ...
  { category: "disk", label: "disk/partition/volume change", pattern: /(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|call|start|stdbuf|setsid)(?:\s+(?!-[vV]\b|--(?:help|version)\b)--?[\w.-]+(?:=\S+)?|\s+--(?=\s)|\s+\/[A-Za-z]+\b|\s+""|\s+\d+|\s+(?!-[vV]\b)-\w+\s+\S+|\s+(?!(?:[\\/]*(?:[\w.-]+[\\/])*)?(?:shutdown|reboot|poweroff|halt|sudo|doas|pkexec|runas|gsudo|su)(?:\.exe)?(?![\w-]))(?:(?:~\/?|%[\w]+%|\$\{?[\w:]+\}?|\.\.?\/|[A-Za-z]:[\\/]|\/)[A-Za-z0-9_./\\:%~${}$-]*|[A-Za-z_][\w.@-]*))*\s+)*(?:[A-Za-z]:[\\/])?(?:[\\/]*(?:[\w.-]+[\\/])*)?(?:mkfs(?:\.\w+)?|fdisk|sfdisk|parted|cfdisk|sgdisk|wipefs|diskpart(?:\.exe)?|diskutil)(?:\.exe)?\b|\bdd\b[^\r\n]*\bof=(?:\/(?:dev|etc|boot|sys|proc|usr|var|opt|root|sbin|bin|lib|private)\/|\\\\\.\\|[A-Za-z]:[\\/])|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|call|start|stdbuf|setsid)(?:\s+(?!-[vV]\b|--(?:help|version)\b)--?[\w.-]+(?:=\S+)?|\s+--(?=\s)|\s+\/[A-Za-z]+\b|\s+""|\s+\d+|\s+(?!-[vV]\b)-\w+\s+\S+|\s+(?!(?:[\\/]*(?:[\w.-]+[\\/])*)?(?:shutdown|reboot|poweroff|halt|sudo|doas|pkexec|runas|gsudo|su)(?:\.exe)?(?![\w-]))(?:(?:~\/?|%[\w]+%|\$\{?[\w:]+\}?|\.\.?\/|[A-Za-z]:[\\/]|\/)[A-Za-z0-9_./\\:%~${}$-]*|[A-Za-z_][\w.@-]*))*\s+)*(?:[A-Za-z]:[\\/])?(?:[\\/]*(?:[\w.-]+[\\/])*)?(?:format(?:\.com|\.exe)\b|format(?:\s+[\/\-][A-Za-z0-9:]+)*\s+[A-Za-z]:(?:\s|$|\/))|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:Clear|Initialize|Set|New|Remove)-(?:Disk|Partition|Volume)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:Format|Resize|New|Remove|Set)-Volume\b|\b(?:format|erase|wipe|partition|resize|initialize)\s+(?:the\s+)?(?:disk|drive|volume|partition)s?\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)vssadmin(?:\.exe)?\b[^\r\n]*\bdelete\b[^\r\n]*\bshadows\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)cipher(?:\.exe)?\b[^\r\n]*\/w\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:Disable-BitLocker|Enable-BitLocker)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)manage-bde(?:\.exe)?\b[^\r\n]*-(?:off|on|protectors\s+(?:delete|add)|forcerecovery)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)fdesetup\b[^\r\n]*\b(?:disable|removepassword|erase|changerecovery)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)mdadm\b[^\r\n]*--(?:stop|zero-superblock|remove|fail|create|grow|manage)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:vgremove|lvremove|pvremove)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?cryptsetup\b[^\r\n]*\b(?:luksFormat|luksErase|erase|luksAddKey|luksRemoveKey|luksKillSlot|luksChangeKey)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?zfs\b[^\r\n]*\b(?:destroy|rollback)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?zpool\b[^\r\n]*\bdestroy\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?btrfs\b[^\r\n]*\bsubvolume\b[^\r\n]*\bdelete\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?xfs_repair\b[^\r\n]*-L\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*(?:swapoff|mkswap|blkdiscard)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*nvme(?:-cli)?\b[^\r\n]*\b(?:format|sanitize|delete-ns)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*sg_format\b[^\r\n]*(?:--format|-F\b)|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*badblocks\b[^\r\n]*-w\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:Reset|Clear)-PhysicalDisk\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?Clear-FileStorageTier\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*hdparm\b[^\r\n]*(?:--(?:security-set-pass|user-master-password|make-bad-sector|security-erase(?:-enhanced|-prompt)?)|-E\b)|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*(?:storcli(?:64)?|perccli(?:64)?|MegaCli(?:64)?)(?:\.exe)?\b[^\r\n]*\b(?:erase|secureerase|PDClear|CfgLdDel|init\s+full|del\s+force)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?fsutil(?:\.exe)?\b[^\r\n]*\bvolume\b[^\r\n]*\bformat\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*smartctl\b[^\r\n]*--sanitize\b(?!\s+status\b)|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*sg_sanitize\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:Remove-StoragePool|Remove-VirtualDisk)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?Optimize-Volume\b[^\r\n]*-WipeFreeSpace\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?defrag(?:\.exe)?\b[^\r\n]*\/[Ww]\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?sdelete(?:\.exe)?\b[^\r\n]*-[zc]\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*camcontrol\b[^\r\n]*\bformat\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*gpart\b[^\r\n]*\b(?:destroy|delete|create|add)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*newfs(?:_[\w]+|\.[\w]+)?\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*diskshadow(?:\.exe)?\b[^\r\n]*\/[sS]\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:Remove|New|Resize)-VHD\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*geli\b[^\r\n]*\b(?:init|attach|detach|setkey|kill|onetime)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*bsdlabel\b[^\r\n]*-[wR]\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*glabel\b[^\r\n]*\b(?:destroy|create)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*(?:arcconf|ssacli|hpacucli)(?:\.exe)?\b[^\r\n]*\b(?:DELETE|delete|erase|forced|SETSTATE|modify\s+erase)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*geom\b[^\r\n]*\b(?:destroy|delete|wipe)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*(?:growfs|tunefs|resize2fs|xfs_growfs|lvresize|pvresize)\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*dmsetup\b[^\r\n]*\bremove\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*losetup\b[^\r\n]*-d\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*camcontrol\b[^\r\n]*\beject\b|(?:^|[;&|\r\n]\s*|&&\s*|\|\|\s*)(?:(?:[\w.]+=\S+\s+)*)?(?:(?:env|busybox|timeout|exec|nohup|nice|command|time|stdbuf|ssh(?:\.exe)?|docker(?:\.exe)?|podman(?:\.exe)?|wsl(?:\.exe)?|xargs|flock|parallel|systemd-run)(?:\s+(?:-\S+|\d+|[\w.]+=\S+|[A-Za-z0-9_@.:/%\\-]+))*\s+)*cryptsetup\b[^\r\n]*\b(?:close|luksClose)\b/i },
