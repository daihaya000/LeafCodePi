...
const state = vi.hoisted(() => ({
  ...
  peekProgress: vi.fn<(taskId: string) => Promise<Awaited<ReturnType<typeof import("./pi/harness").peekCodeRequestProgress>>>>(async () => ({})),
...
describe("room conversation with delegated work", () => {
  ...
  it("mirrors progress for every outstanding Code request of the turn", async () => {
    ...
    // and keep the shared activity label for the sibling.
