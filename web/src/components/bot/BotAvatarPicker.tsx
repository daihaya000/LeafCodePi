      ...
      {open && <div id={`${uid}-picker`} role="dialog" aria-label="ボットのアイコン" className="absolute inset-x-0 top-full z-30 flex max-h-[55dvh] flex-col overflow-hidden rounded-[20px] border border-border bg-surface/95 text-text shadow-[0_8px_30px_rgba(0,0,0,0.12)] backdrop-blur-xl">
        ...
        <div className="min-h-0 overflow-y-auto overscroll-contain p-4">
          <div className="mb-4 flex items-center justify-between rounded-xl bg-surface-2 px-3 py-2">
            <div className="flex items-center gap-2"><BotAvatar size={40} {...bot} name="アニメーションプレビュー" active={previewAnimation} className={previewAnimation ? "bot-avatar-preview" : undefined} /><span className="text-xs text-muted">アニメーションプレビュー</span></div>
