...
type SidebarBot = BotDto & SidebarPreview & { codeInProgress?: boolean };
            ...
            {bots.map((bot) => {
              ...
              return (
                <li key={bot.id}>
                  ...
                  >
                    <BotAvatar size={40} {...bot} active={bot.codeInProgress === true} />
