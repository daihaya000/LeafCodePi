      ...
      <div className="flex items-end gap-3 px-1 pb-1 pt-2">
        <div className="relative min-w-0 flex-1">
          <div
            ...
            aria-label="タスク設定"
            tabIndex={0}
            className="flex min-w-0 flex-nowrap items-center gap-x-2 overflow-x-auto overscroll-x-contain rounded-xl [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden [&_button]:shadow-none [&_button]:rounded-xl [&_button]:border-transparent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
            {attachmentInput}
            <button
              type="button"
